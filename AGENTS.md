...
- **A credential a managed service needs must reach Compose through the agent's child environment**, not
...
- **Nothing in the base compose file may guard a managed service's variables with `${VAR:?}`.**
