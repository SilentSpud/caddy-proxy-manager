...
/**
 * The last comma-separated segment of a possibly-combined header value. "" for missing or empty,
 * so callers treat "absent" and "present but useless" alike; single values pass through.
 */
