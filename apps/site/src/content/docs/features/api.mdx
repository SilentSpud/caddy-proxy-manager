...
Most of what the dashboard does, it does through an API you can use too - certificates and
agents are read-only there, and users are managed rather than created.
